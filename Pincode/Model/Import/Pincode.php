<?php
namespace Magentomaster\Pincode\Model\Import;

use Magentomaster\Pincode\Model\Import\Pincode\RowValidatorInterface as ValidatorInterface;
...
class Pincode extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    ...
    const ID = 'id';
    const EVENTNAME = 'pincode';
    const IMGURL = 'courier_name';
    const BANNERIMGURL = 'city_name';
    const DESC = 'state_name';
    const LDESC = 'state_code';
    const PLACE = 'cod';

    const TABLE_Entity = 'pincode';
